...
const teamMembers: TeamMember[] = [
  {
    ...
    name: "정현김",
    role: "팀 리더 / 풀스택 개발자",
    description: "EinCode 팀을 이끌고 있는 풀스택 개발자. 현대적인 웹 기술과 시스템 아키텍처에 관심이 많습니다.",
  ...
  },
  {
    ...
    name: "김개발자",
    role: "프론트엔드 개발자",
    description: "사용자 중심의 UI/UX를 만드는 것을 좋아합니다. 최신 웹 기술 트렌드를 따라가며 학습 중입니다.",
  ...
  },
  {
    ...
    name: "이백엔드",
    role: "백엔드 개발자",
    description: "데이터베이스 설계와 API 개발을 전문으로 합니다. 견고한 서버 아키텍처 구축에 열정이 있습니다.",
  ...
  },
  {
    ...
    description: "클라우드 인프라와 배포 자동화를 담당합니다. 안정적이고 확장 가능한 시스템 구축을 목표로 합니다.",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 space-y-4 animate-fade-in-up">
          ...
          <p className="max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed">
            ...
            각자의 역량을 모아 창의적이고 혁신적인 프로젝트들을 만들어나가고 있습니다.
          </p>
        </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  최신 기술 트렌드를 따라가며 계속 학습하고 성장하는 개발자 팀입니다.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  다양한 분야의 전문가들이 함께 소통하며 더 나은 결과를 만들어냅니다.
                </p>
              </div>
