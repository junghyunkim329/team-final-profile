...
const notes = [
  {
    ...
    excerpt:
      '커널 컴파일, BusyBox 설정, Syslinux를 사용한 부팅 가능한 ISO 생성의 학습 내용.',
    date: '2025년 11월',
    category: '시스템',
  ...
  },
  {
    ...
    excerpt:
      'Next.js 16의 새로운 기능 탐색 및 Tailwind CSS v4의 새로운 설정 시스템으로 마이그레이션.',
    date: '2024년 12월',
    category: '프론트엔드',
  ...
  },
  {
    ...
    excerpt:
      'Llama2를 로컬에서 실행하고 자연어 작업을 위한 개인용 챗봇 API 구축하기.',
    date: '2023년 10월',
    category: 'AI',
